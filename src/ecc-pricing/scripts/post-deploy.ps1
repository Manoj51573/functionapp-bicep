...
$resourceId = (Get-AzResource -ResourceGroupName "rg-ae-ais-$environmentName-eccpricing" -ResourceName "func-ae-ais-$environmentName-eccpricing" -ResourceType "Microsoft.Web/sites").ResourceId
...
$secretName = "func-ae-ais-$environmentName-eccpricing-$functionName-key"
